function Card_1() {
    return (
        <div className="cards">
            <h1 className="card_heading">About Me</h1>
            <sub>
            Hi! My name is Adyan Chowdhury. I am a Bengali American who is currently
            ...
            vero deleniti optio consectetur libero, voluptas nihil temporibus!.
            </sub>
        </div>
    );
}
